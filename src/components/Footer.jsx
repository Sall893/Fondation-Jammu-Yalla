            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="md:col-span-3">
                        ...
                        <div className="space-y-6 text-gray-400">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-sm">(+221) 76 643 20 45</p>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="p-3 bg-white/5 rounded-lg text-brand-blue">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                </div>
                                <p className="text-sm">contact@jaamu-yalla.org</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-white/10 pt-12 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex items-center gap-8">
                        <span className="text-gray-500 text-[10px] uppercase tracking-[0.2em] font-black">Partenaire Officiel</span>
                        <div className="flex items-center gap-2 transition-all cursor-default">
                            <img
                                src={powertechLogo}
                                alt="Logo Groupe PowerTech"
                                className="h-8 w-auto brightness-0 invert opacity-40 hover:opacity-100 transition-all"
                            />
                        </div>
                    </div>
